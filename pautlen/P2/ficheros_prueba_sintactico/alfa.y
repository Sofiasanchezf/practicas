...
exp: exp TOK_MAS exp {fprintf(yyout, ";R72:\t<exp> ::= <exp> + <exp>\n");}
	...
	| TOK_MENOS exp %prec TOK_NOT {fprintf(yyout, ";R76:\t<exp> ::= - <exp>\n");}
...
comparacion: exp TOK_IGUAL exp {fprintf(yyout, ";R93:\t<exp> ::= <exp> == <exp>\n");}
			| exp TOK_DISTINTO exp {fprintf(yyout, ";R94:\t<exp> ::= <exp> != <exp>\n");}
			| exp TOK_MENORIGUAL exp {fprintf(yyout, ";R95:\t<exp> ::= <exp> <= <exp>\n");}
			| exp TOK_MAYORIGUAL exp {fprintf(yyout, ";R96:\t<exp> ::= <exp> >= <exp>\n");}
			| exp TOK_MENOR exp {fprintf(yyout, ";R97:\t<exp> ::= <exp> < <exp>\n");}
			| exp TOK_MAYOR exp {fprintf(yyout, ";R98:\t<exp> ::= <exp> > <exp>\n");}
;
