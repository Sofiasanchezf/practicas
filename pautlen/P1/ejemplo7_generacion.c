...
int main (int argc, char ** argv)
{
  ...
  // printf doble(z)
  //Llamamos a la funcion que tiene 1 argumento. Estamos dando un salto a la etiqueta.
  // Primero apilamos el parametro.
  operandoEnPilaAArgumento(fd_asm,1);
  llamarFuncion(fd_asm,"doble",1); /*Pregunta: por que le pasan la _ al nombre? */
